(function(factory) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      infoTextFiltered: '<span class="badge bg-warning">Filtered</span> {0} from {1}', // when not all of the options are visible due to the filter
      ...
      btnClass: 'btn-outline-info',                                                  // sets the button style class for all the buttons
  ...
  BootstrapDualListbox.prototype = {
    init: function () {
      ...
      this.container = $('' +
        ...
        '     <button type="button" class="btn btn-primary btn-sm clear1" style="float:right!important;"></button>' +
        '   </span>' +
