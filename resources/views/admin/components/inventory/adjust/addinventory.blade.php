                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Bản tin</a></li>
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Điều chỉnh vật tư</a></li>
                            <li class="breadcrumb-item active">Tạo phiếu điều chỉnh</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Tạo phiếu điều chỉnh</h4>
                </div>
            </div>
        </div>
